...
@protocol CSSlideSwitchViewDelegate;

@interface CSSlideSwitchView : UIView<UIScrollViewDelegate>
{
...
@protocol CSSlideSwitchViewDelegate <NSObject>
@required
/*!
 * @method 顶部tab个数
 * @abstract
 ...
 * @result
 */
- (void)slideSwitchView:(CSSlideSwitchView *)view panRightEdge:(UIPanGestureRecognizer*) panParam;
