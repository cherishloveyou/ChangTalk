...
@interface CSFullScreenPhotoBrowseView ()<UIScrollViewDelegate>
...
@implementation CSFullScreenPhotoBrowseView
    ...
    if (self.thumbnail) {
        ...
        [UIView animateWithDuration:PREVIEW_ANIMATION_DURATION animations:^{
            ...
            if (self.urlPath) {
                ...
                [_imageView setImageWithURL:[NSURL URLWithString:self.urlPath] placeholderImage:nil];
            }
        }];
    }
    else {
